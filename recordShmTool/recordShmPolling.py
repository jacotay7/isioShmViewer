...
# Add helper comment at the end of the file explaining how to read the data back
"""
# How to read back the captured data:
#
# After running the capture tool, you can read back the binary data using the provided function:
#
# ```python
# # Import the function
# from recordShmPolling import read_shm_capture_file
#
# # Read the capture file
# data = read_shm_capture_file('/path/to/your_capture_file.bin')
#
# # Get metadata
...
# ```
#
# You can also create a simple script to plot or analyze the captured frames:
#
# ```python
# import numpy as np
# import matplotlib.pyplot as plt
...
# frame_values = [np.mean(frame_data['frame']) for frame_data in frames]
# timestamps = [frame_data['timestamp'] for frame_data in frames]
# rel_timestamps = [t - timestamps[0] for t in timestamps]
#
# plt.figure(figsize=(10, 6))
# plt.plot(rel_timestamps, frame_values)
# plt.title('Mean Frame Values Over Time')
